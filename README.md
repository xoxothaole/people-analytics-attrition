...
Five stakeholder questions were addressed in [`hr_attrition_queries.sql`](sql/hr_attrition_queries.sql). All queries were written using CTEs for readability and compatibility with Snowflake and MS SQL Server environments.
